...
async function migrate() {
  ...
  try {
    console.log("Adding tanggal_capa to permohonan_inspeksi...");
    await pool.query(`
      ALTER TABLE permohonan_inspeksi 
      ADD COLUMN tanggal_capa DATE DEFAULT NULL AFTER tanggal_terima
    `).catch(e => {
      if (e.code === 'ER_DUP_FIELDNAME') console.log("tanggal_capa already exists.");
      else throw e;
    });

    console.log("Creating table capa_inspeksi...");
    await pool.query(`
